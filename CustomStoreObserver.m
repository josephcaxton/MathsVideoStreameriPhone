...
- (void) failedTransaction: (SKPaymentTransaction *)transaction
{
	...
	{
       // NSLog(@"Error happened %@", transaction.error);
...
-(NSString *)WorkOutSubsriptionInDays:(NSString*)theProductID{
    ...
    if ([[theProductID lowercaseString] isEqualToString:@"mathsiphone1week"] ){
 ...
 else   if ([[theProductID lowercaseString] isEqualToString:@"mathsiphone1month"] ){
        
        return @"31";
        
    }
    
    else if ([[theProductID lowercaseString] isEqualToString:@"mathsiphone3months"] ){
        
        return @"93";
        
    }
    else if ([[theProductID lowercaseString] isEqualToString:@"mathsiphone6months"] ){
        
        return @"186";
        
    }
    
    else if ([[theProductID lowercaseString] isEqualToString:@"mathsiphone9months"] ){
        
        return @"279";
        
    }
    else if ([[theProductID lowercaseString] isEqualToString:@"mathsiphone12months"] ){
...
-(void)SendToLearnersCloud{
    ...
    VerificationAppID = @"2"; //Maths iPhone
