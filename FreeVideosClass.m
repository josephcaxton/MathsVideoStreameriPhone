...
- (void)reviewPressed {
    ...
    // Report to  analytics
    NSError *error;
    if (![[GANTracker sharedTracker] trackEvent:@"User Sent to Review Math Videos iPhone at app store"
                                         action:@"User Sent to Review Maths Videos iPhone at app store"
                                          label:@"User Sent to Review Maths Videos iPhone at app store"
                                          value:1
                                      withError:&error]) {
    ...
    NSString *str = @"https://userpub.itunes.apple.com/WebObjects/MZUserPublishing.woa/wa/addUserReview?id=531691732&type=Purple+Software"; 
